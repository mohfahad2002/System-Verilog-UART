...
logic [7:0] rx_test_data = 8'b11101110;
logic [7:0] tx_received = 'd0;
logic [7:0] tx_test_data = 8'b11101110;
...
task automatic test_rx();
    ...
    for (int i = 0; i < 8; i++) begin
        rx_in = rx_test_data[0];
        rx_test_data = rx_test_data >> 1;
        wait_baud();
    end
...
initial begin
    rst_n = 0;
    tx_test_data = $urandom_range(8'hFF, 0);
